...
function iamsocial_scripts() {
    ...
    wp_enqueue_style( 'bootstrap', get_template_directory_uri() . '/css/bootstrap.css', array( '' ), '1.0.8', true );
    wp_enqueue_style('bootstrap-datetimepicker', get_template_directory_uri() . '/css/bootstrap-datetimepicker.css');
    wp_enqueue_style('datetimepicker', get_template_directory_uri() . '/css/datetimepicker.css');
    wp_enqueue_style('jquery.realperson', get_template_directory_uri() . '/css/jquery.realperson.css');
    ...
    wp_enqueue_script('moment', get_template_directory_uri() . '/js/moment.js', array(), false, true);
    wp_enqueue_script('bootstrap-datetimepicker', get_template_directory_uri() . '/js/bootstrap-datetimepicker.js', array(), false, true);
    wp_enqueue_script('jquery.plugin', get_template_directory_uri() . '/js/jquery.plugin.js', array(), false, true);
    wp_enqueue_script('jquery.realperson', get_template_directory_uri() . '/js/jquery.realperson.js', array(), false, true);
    wp_enqueue_script('select2', get_template_directory_uri() . '/js/select2.full.min.js','4.0.3' , true);
...
*
*/
load_template( trailingslashit( get_template_directory() ) . 'cpt/servicios.php' );
/*
* provincias
*
*/
load_template( trailingslashit( get_template_directory() ) . 'cpt/provincias.php' );

/*
* reservaciones
*
*/
load_template( trailingslashit( get_template_directory() ) . 'cpt/reservaciones.php' );
/*
* autos
*
*/
load_template( trailingslashit( get_template_directory() ) . 'cpt/autos.php' );

/*
* hoteles
*
*/
load_template( trailingslashit( get_template_directory() ) . 'cpt/hoteles.php' );
/*
* internacionales
*
*/
load_template( trailingslashit( get_template_directory() ) . 'cpt/internacionales.php' );
